...
public class ClienteIntegracionDTO implements Serializable{
	/**
	 * 
	 */
	...
	//Constructor
	public ClienteIntegracionDTO(Integer idClienteTienda, String cuil_cuit_dni, String nombreYApellido_RazonSocial,
			String email) {
		super();
